...
const taxi = new Taxi('taxi', 5)
const taxi1 = new Taxi('taxi', 6)
const taxi2 = new Taxi('taxi', 4)
const taxi3 = new Taxi('taxi', 4)

const truck = new Truck('truck', 20000)
const truck1 = new Truck('truck', 40000)
const truck2 = new Truck('truck', 80000)
...
console.log(taxopark.filterByCapacity(30000))
console.log(taxopark.filterBySeats(5))
